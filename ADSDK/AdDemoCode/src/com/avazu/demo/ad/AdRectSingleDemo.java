...
//		mLayout.setPadding(Tools.dip2px(this, 10), 0, Tools.dip2px(this, 10), 0);
	...
	private AdView createSingleAdView(){
		L.i("createSingleAdView");
		int screenWidth = getResources().getDisplayMetrics().widthPixels;
		int screenWidthDip = Utils.px2dp(this, screenWidth);
		int showWidthDip = screenWidthDip * 2 ;
		int showHeightDip = showWidthDip * 175 / (97 * 6);
		AdViewController controller = new AdViewController(showWidthDip, showHeightDip, AdViewController.TYPE_RECT_SINGLE, true);
		...
		AdView ret =  AdViewFactory.createAdView(AdRectSingleDemo.this, controller);
		ret.setLayoutParams(createLayoutParams(Tools.dip2px(this, showWidthDip+1), 
				Tools.dip2px(this, showHeightDip+1)));
		return ret;
	}
