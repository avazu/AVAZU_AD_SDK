...
public class AdSubscriptionManager {
    ...
    public static boolean adClickToNewWebview(Context mContext, String url) {
        Intent i = new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(url));
        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ActivityInfo systemBrowser = Utils.getSystemBrowser(mContext);
        if (systemBrowser != null) {
            i.setClassName(systemBrowser.packageName, systemBrowser.name);
        }
        try {
