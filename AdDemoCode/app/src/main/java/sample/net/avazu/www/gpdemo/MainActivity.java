...
public class MainActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.set_browser_short_cut).setOnClickListener(this);
		findViewById(R.id.raw_data).setOnClickListener(this);

		AdSdk.initialize(getApplicationContext(), "6395");
	}
...
//			AvazuAdSdk.setAppOpenHijackEnable(this, true);
			...
			break;
        case R.id.set_browser_short_cut:
//            AvazuAdSdk.setDesktopBrowser(this);
            break;
        case R.id.raw_data:
